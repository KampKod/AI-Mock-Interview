...
export const MacbookScroll = ({
  ...
  const translate = useTransform(scrollYProgress, [0, 1], [0, isMobile ? 800:600]);
  ...
  return (
    (<div
      ref={ref}
      className="min-h-[100vh] flex flex-col items-center py-0 md:py-40 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100 scale-[0.45] sm:scale-45">
      <motion.h2
        style={{
...
export const Keypad = () => {
  return (
    (<div className="h-full rounded-md bg-[#050505] mx-1 p-1 z-[-20]">
      {/* First Row */}
      <Row>
        <KBtn
